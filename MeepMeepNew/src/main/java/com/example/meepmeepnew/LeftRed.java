        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-41, -65, Math.toRadians(90)))
                                ...
                                .splineToConstantHeading(new Vector2d(-60, -12), Math.toRadians(180)) // Left, Position 1
                                .splineToConstantHeading(new Vector2d(-12, -12), Math.toRadians(0)) // Right, Position 3
