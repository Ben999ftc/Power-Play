        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-41, 65, Math.toRadians(270)))
                                ...
                                .splineToConstantHeading(new Vector2d(-60, 12), Math.toRadians(180)) // Right, Position 3
                                .splineToConstantHeading(new Vector2d(-12, 12), Math.toRadians(0)) // Left, Position 1
